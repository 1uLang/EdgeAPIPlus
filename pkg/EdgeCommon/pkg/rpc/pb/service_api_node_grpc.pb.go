...
type APINodeServiceClient interface {
	...
	// 计算使用某个国密证书的API节点数量
	CountAllEnabledAPINodesWithGMCertId(ctx context.Context, in *CountAllEnabledAPINodesWithGMCertIdRequest, opts ...grpc.CallOption) (*RPCCountResponse, error)
	// 修改调试模式状态
...
func (c *aPINodeServiceClient) CountAllEnabledAPINodesWithGMCertId(ctx context.Context, in *CountAllEnabledAPINodesWithGMCertIdRequest, opts ...grpc.CallOption) (*RPCCountResponse, error) {
	out := new(RPCCountResponse)
	err := c.cc.Invoke(ctx, "/pb.APINodeService/countAllEnabledAPINodesWithGMCertId", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type APINodeServiceServer interface {
	...
	// 计算使用某个国密证书的API节点数量
	CountAllEnabledAPINodesWithGMCertId(context.Context, *CountAllEnabledAPINodesWithGMCertIdRequest) (*RPCCountResponse, error)
	// 修改调试模式状态
...
func (UnimplementedAPINodeServiceServer) CountAllEnabledAPINodesWithGMCertId(context.Context, *CountAllEnabledAPINodesWithGMCertIdRequest) (*RPCCountResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CountAllEnabledAPINodesWithGMCertId not implemented")
}
...
func _APINodeService_CountAllEnabledAPINodesWithGMCertId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CountAllEnabledAPINodesWithGMCertIdRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(APINodeServiceServer).CountAllEnabledAPINodesWithGMCertId(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.APINodeService/countAllEnabledAPINodesWithGMCertId",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(APINodeServiceServer).CountAllEnabledAPINodesWithGMCertId(ctx, req.(*CountAllEnabledAPINodesWithGMCertIdRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var APINodeService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "countAllEnabledAPINodesWithGMCertId",
			Handler:    _APINodeService_CountAllEnabledAPINodesWithGMCertId_Handler,
		},
		{
