...
replace github.com/TeaOSLab/EdgeCommon => ./pkg/EdgeCommon

replace github.com/TeaOSLab/EdgePlus => ./pkg/EdgePlus

//replace github.com/go-acme/lego/v4 => /Users/WorkSpace/Projects/lego
...
require (
	github.com/1uLang/gmsm v1.0.2 // indirect
